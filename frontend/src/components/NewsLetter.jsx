  ...
  return (
    <div className="flex justify-between w-full h-[360px] overflow-hidden">
      ...
      <div className="bg-gray-100 w-full flex flex-col justify-center items-center gap-3">
        <h2 className="w-[456px] h-[44px] font-semibold leading-10 text-5xl text-black">Join Our Newsletter</h2>
        <p className="w-[540px] h-[30px] font-normal leading-7 text-xl text-center tracking-wider ">Sign up for deals, new products and promotions</p>
        <div className="flex items-center justify-between">

         <div className="flex w-[488px] items-center gap-2 mt-5">
        ...
        <div className="w-[540px] h-[1px] bg-gray-500"></div>
      </div>
